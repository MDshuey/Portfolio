...
--
-- Table structure for table `termination_dc`
--

DROP TABLE IF EXISTS `termination_dc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `termination_dc` (
  `TERM_CD` varchar(3) DEFAULT NULL,
  `TERMINATION_DESCR` varchar(120) DEFAULT NULL,
  `NOTES` varchar(1000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `termination_dc`
--

LOCK TABLES `termination_dc` WRITE;
/*!40000 ALTER TABLE `termination_dc` DISABLE KEYS */;
INSERT INTO `termination_dc` VALUES ('B','broken','cord has been broken'),('C','cut','cord has been cut (sharper end than broken)'),('R','ravelled','plies are coming apart'),('K','knotted','cord ends with a knot near the bottom'),('D','doubled','end of cord is doubled over'),('U','unfinished','not knotted; not broken; not cut... just ends'),('TT','canutito','end of cord is wrapped with colored thread');
/*!40000 ALTER TABLE `termination_dc` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-09-17 13:55:53
